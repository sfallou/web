...
/**
 * @ORM\Entity(repositoryClass="OCPlateformBundle\Entity\ApplicationRepository")
 */
class Application
{
   /**
   * @ORM\ManyToOne(targetEntity="OCPlateformBundle\Entity\Advert", inversedBy="applications")
