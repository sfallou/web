		...
		<table border="1" width="80%" height="50%" align="center" cellspacing="10">
			...
			<tr>
				...
				<td align="center" align="center" valign="top">
					<center><h2 class="text">Liste des abonnés</h2></center>
					...
					<table border="1"  >
						<tr>
						<td class="text">
						<div id="1ieme"   style="display: none;"><?php include("seokhaye.php");?></div>
						<div id="2ieme"   style="display: none;"><?php include("sine.php");?></div>
						<div id="3ieme"   style="display: none;"><?php include("keur_ibra.php");?></div>
						<div id="4ieme"   style="display: none;"><?php include("kanene.php");?></div>
						<div id="5ieme"   style="display: none;"><?php include("daraja.php");?></div>
						<div id="6ieme"   style="display: none;"><?php include("keur_mory.php");?></div>
						<div id="7ieme"   style="display: none;"><?php include("keur_malamine.php");?></div>
						<div id="8ieme"   style="display: none;"><?php include("khourwa.php");?></div>
						</td>
						</tr>
					</table>
				</td>
