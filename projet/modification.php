...
<!--Fin bouton de déconnexion-->
	...
	<div class="row">
		<div class="col-md-12">
			...
			<div class="tabbable" id="tabs-699130">
				<ul class="nav nav-tabs">
					<li>
						<a href="#panel-658609" data-toggle="tab">Section 1</a>
					</li>
					<li class="active">
						<a href="#panel-971189" data-toggle="tab">Section 2</a>
					</li>
				</ul>
				<div class="tab-content">
					<div class="tab-pane" id="panel-658609">
						<p>
							I'm in Section 1.
						</p>
					</div>
					<div class="tab-pane active" id="panel-971189">
						<p>
