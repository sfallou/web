 ...
 */
function actualiserIndex()
{
    var listeInd = requete.responseText;
    var blocListe = document.getElementById('blocIndex');
    blocListe.innerHTML = listeInd;
}
...
function getIndex(idm)
{
    ...
    {*/
        ...
        var url = 'infos_index.php?idm='+ idm;
