...
class abonne{
	...
	function ajouterAbonne($bdd, $cni, $nom, $prenom, $addr, $tel, $frais){
		$req=$bdd->prepare("INSERT INTO abonne(id_abonne, nom, prenom, cni, adresse, telephone, date_abonnement, frais_abonnement, etat) VALUES (:n0, :n1, :n2, :n3, :n4, :n5, :n6, :n7, :n8)");
		$req->execute(array(
			':n0'=>$this->id,
			':n1'=>$nom,
			 ':n2'=>$prenom, 
