...
if(isset($_POST['id_abonne']) and !empty($_POST['id_abonne']) and isset($_POST['id_compteur']) and !empty($_POST['id_compteur'])){
...
<?php 
	...
	echo
			...
			<center><form method="post" action="modifier_index.php">
