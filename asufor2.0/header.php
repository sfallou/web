            ...
            <div class="sidebar-nav">
                <div class="nav-canvas">
                    ...
                    <ul class="nav nav-pills nav-stacked main-menu">
                        ...
                        <li class="accordion">
                            <a class="ajax-link" href="ui.php"><i class="glyphicon glyphicon-user"></i><span> Gestion abonnés </span><i class="glyphicon glyphicon-thumbs-down"></i></a>
                        ...
                        <li><a href="contact.php"><i class="glyphicon  glyphicon-flag"></i><span>Contact</span></a>
                        </li>
                    </ul>
