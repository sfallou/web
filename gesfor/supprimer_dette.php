		...
		while($don=$req->fetch())
			{
				...
				<tr>
					...
					<td>
						<a class="btn btn-danger orange" href="traitement_supprimer_dette.php?id=<?php echo $id_dette;?>" onclick="return(confirm('Etes-vous sûr de vouloir supprimer cette dette?'));">
