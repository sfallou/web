...
?>
    ...
    <tr>
        ...
        <td class="center">
            <a class="btn btn-success" href="traitement_liste.php?id_abonne=<?php echo $don['id_abonne'];?>">
            ...
            <a class="btn btn-danger orange" href="listeabonnes.php?id=<?php echo $don['id_abonne'];?>" onclick="return(confirm('Etes-vous sûr de vouloir supprimer cet abonné?'));">
