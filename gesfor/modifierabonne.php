...
if(isset($_GET['id']) or !empty($_GET['id'])){
 ...
 <center>
		<form role='form' action="" method='post'>
			...
			<option value="<?php echo $infos['adresse'];?>"><?php echo $infos['adresse'];?></option>
		<?php
	...
	<p class="center col-md-5"><button class="btn btn-primary" type="submit">Enregistrer</button>&nbsp;&nbsp;<a class="btn btn-default" href="listeabonnes.php" >Annuler</button></p>
	</form>
	</center>
	</div>
	</div>
