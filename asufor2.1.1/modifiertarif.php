<?php
	...
	if(isset($_GET['code']) and !empty($_GET['code'])){
		...
		$req=$bdd->prepare('UPDATE tarif SET montant_tarif=:n1, date_tarif=:n3 WHERE id_tarif=:n2');
...
?>
    ...
    <tr>
        <td>tarif normal</td>
        <td class="center"><?php echo $tarif;?></td>
        <td class="center"><?php echo $datetarif;?></td>
                <td class="center">
    ...
    <tr>
        <td>tarif spécial</td>
        <td class="center"><?php echo $tarifSpecial;?></td>
        <td class="center"><?php echo $datetarifSpecial;?></td>
                <td class="center">
