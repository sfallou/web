            ...
            <div class="sidebar-nav">
                <div class="nav-canvas">
                    ...
                    <ul class="nav nav-pills nav-stacked main-menu">
                        ...
                        <li><a class="ajax-link" href="index.php"><i class="glyphicon glyphicon-barcode"> </i><span> Statistique</span></a>
                        </li>
                        ...
                        <li><a href="supprimerabonne.php"><i class="glyphicon glyphicon-globe"></i><span>Supprimer Abonnés</span></a></li>
                        <li><a class="ajax-link" href="utilisateur.php"><i
                                    class="glyphicon glyphicon-star"></i><span>Modifier Compte</span></a></li><?php } ?>
                        <li class="nav-header">Plus</li>
                         <li><a href="login.html"><i class="glyphicon glyphicon-print"></i><span>Imprimer</span></a>
                        </li>
