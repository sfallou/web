    ...
    <div class="navbar navbar-default" role="navigation">
        ...
        <div class="navbar-inner">
            ...
            <div class="btn-group pull-right">
                ...
                <?php 
					if($_SESSION['statut']=='administrateur') {$n=1;}
					else if($_SESSION['statut']=='gerant') {$n=2;}
					else {$n=3;}
                ?>
                <ul class="dropdown-menu">
                    <li><a href="profil.php?id=<?php echo $n;?>">Profile</a></li>
                    <li class="divider"></li>
                ...
                <div class="nav-canvas">
                    ...
                    <ul class="nav nav-pills nav-stacked main-menu">
                        ...
                        <li><a class="ajax-link" href="enregistrer_depense.php"><i
                         ...
                         <li class="accordion">
                            <a href="#"><i class="glyphicon glyphicon-eye-open"></i><span> Dettes</span></a>
                            <ul class="nav nav-pills nav-stacked">
                        ...
                        <li><a href="contact.php"><i class="glyphicon glyphicon-lock"></i><span>Contact</span></a>
                        </li>
                    </ul>
