			...
			<tr>
				...
				<td align="center" align="center" valign="top">
					...
					<table border="1" >
						...
						<div id="1ieme"   style="display: none;"><?php include("g_liste_verte.php");?></div>
						<div id="2ieme"   style="display: none;"><?php include("g_liste_rouge.php");?></div>
						<div id="3ieme"   style="display: none;"><?php include("g_liste_suspendu.php");?></div>
						</td>
						</tr>
					</table>
