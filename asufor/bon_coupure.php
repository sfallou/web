	...
	<body>
		<table border="1" width="80%" height="50%" align="center" cellspacing="10">
			...
			<table>
				...
				<tr><td><table style="margin-left:20px;"><tr><td>N°facture impayée: <?php echo $donnees['id_compteur'];?><br/>Date: <?php echo "$jour/$mois/$annee";?><br/>N°Abonné: <?php echo $donnees['id_abonne']; ?><br/></td>
				...
				<tr>
					<table border="1">
			<tr>
				<th colspan="6" >Détails de la facture coupée</th></tr>
			<tr>
				<th>An-index</th>
				<th>Nv-index</th>
